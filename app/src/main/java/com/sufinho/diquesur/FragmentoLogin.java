 ...
 */
public class FragmentoLogin extends Fragment implements LoaderCallbacks<Cursor>, GoogleApiClient.OnConnectionFailedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.fragmento_login, container, false);
        ...
        logo = (ImageView) findViewById(R.id.iVlog);
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        if (result.isSuccess()) {
           ...
           /* mPasswordView.setText(acct.getDisplayName());
...
/*
    private void updateUI(boolean signedIn) {
        if (signedIn) {
            ...
            mPasswordView.setText("Desconectado");
            mEmailView.setText("Desconectado");
...
/*
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(FragmentoLogin.this,
